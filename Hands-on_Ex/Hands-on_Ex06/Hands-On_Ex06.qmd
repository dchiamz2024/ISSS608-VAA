...
### **Step : Taking a Glimpse and Understanding the Dataset**
...
sg_ts %>%
  ...
  ggplot(aes(day, month, fill = new_cases)) +
    geom_tile(color = "white") +
    facet_wrap(~ year, ncol = 1) +
    scale_fill_viridis_c(trans = "sqrt", na.value = "grey90") +
    labs(
      title = "Calendar Heatmap: Daily New Cases (Singapore)",
      x = "Day of Month", y = NULL, fill = "New Cases"
    ) +
    theme_minimal() +
    theme(
