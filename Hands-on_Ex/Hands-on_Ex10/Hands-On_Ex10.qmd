...
library(RODBC)
con <- odbcConnectAccess2007('DataEx10/Coffee Chain.mdb')
coffeechain <- sqlFetch(con, 'CoffeeChain Query')
write_rds(coffeechain, "DataEx10/CoffeeChain.rds")
odbcClose(con)
```
...
```{r}
coffeechain <- read_rds("DataEx10/CoffeeChain.rds")
```
...
### **19.6.1 Plotting Coffechain Sales report**
