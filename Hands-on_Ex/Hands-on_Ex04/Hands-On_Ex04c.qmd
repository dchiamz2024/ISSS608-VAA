...
-   `roup_by()` of **dplyr** package is used to group the observation by RACE,
...
![](/Images/Hands-on_Image08.png){fig-align="center"}
...
::: callout-note
This function comes with many arguments, readers are advised to read the syntax reference for more detail.
:::
...
**This is an attempt to plot both 95% and 99% confidence intervals.**
