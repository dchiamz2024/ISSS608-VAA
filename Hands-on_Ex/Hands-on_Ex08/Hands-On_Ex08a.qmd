...
```{r}
mpsz <- st_read(dsn = "DataEx08/geospatial", 
...
```{r}
popdata <- read_csv("DataEx08/aspatial/respopagesextod2011to2020.csv")
```
...
#### 11.3.4.2 Joining the attribute data and geospatial data
...
```{r}
write_rds(mpsz_pop2020, "DataEx08/rds/mpszpop2020.rds")
```

## **11.4 Choropleth Mapping Geospatial Data Using *tmap***
...
### **11.4.1 Plotting a choropleth map quickly by using *qtm()***
...
### **11.4.2 Creating a choropleth map by using *tmap*’s elements**
...
#### 11.4.2.2 Drawing a choropleth map using *tm_polygons()*
...
#### 11.4.2.3 Drawing a choropleth map using *tm_fill()* and \*tm_border()\*\*
...
### **11.4.3 Data classification methods of tmap**
...
#### 11.4.3.1 Plotting choropleth maps with built-in classification methods
...
#### 11.4.3.2 Plotting choropleth map with custome break
...
### **11.4.4 Colour Scheme**

**tmap** supports colour ramps either defined by the user or a set of predefined colour ramps from the **RColorBrewer** package.

#### 11.4.4.1 Using ColourBrewer palette
...
#### 11.4.5.3 Cartographic Furniture
...
### **11.4.6 Drawing Small Multiple Choropleth Maps**
...
#### 11.4.6.1 By assigning multiple values to at least one of the aesthetic arguments
...
#### 11.4.6.2 By defining a group-by variable in *tm_facets()*
...
#### 11.4.6.3 By creating multiple stand-alone maps with `tmap_arrange()`
...
### **11.4.7 Mappping Spatial Object Meeting a Selection Criterion**
...
### **11.5.2 Geospatial data wrangling**
